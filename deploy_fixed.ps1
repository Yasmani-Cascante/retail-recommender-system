...
$SERVICE_NAME = "retail-recommender-fixed"
$REGION = "us-central1"
...
Write-Host "Desplegando versión con embeddings pre-computados (fixed)" -ForegroundColor Cyan
Write-Host "===================================================" -ForegroundColor Cyan
...
docker build -t $IMAGE_NAME -f Dockerfile.fixed .
