      ...
      {showActionBar && (
        <div className={styles.actionBar} onClick={e => e.stopPropagation()}>
          ...
          >
            ...
            <svg viewBox="0 0 24 24" width="25" fill="currentColor" strokeWidth="0.1" aria-hidden="true">
          ...
          {onShowSimilar && (
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="22" fill="currentColor" stroke="currentColor"  strokeWidth="0.1" aria-hidden="true">
