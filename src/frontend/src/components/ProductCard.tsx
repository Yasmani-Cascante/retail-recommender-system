      ...
      {showActionBar && (
        <div className={styles.actionBar} onClick={e => e.stopPropagation()}>
          ...
          {onShowSimilar && (
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="18" height="18" fill="currentColor" stroke="currentColor"  strokeWidth="0.1" aria-hidden="true">
          ...
          {onChatAbout && (
            ...
            >
              ...
              <svg height="24" viewBox="0 0 24 24" width="20" fill="currentColor" aria-hidden="true"
          ...
          >
            ...
            <svg viewBox="0 0 24 24" width="21" stroke="currentColor" strokeWidth="0.1" aria-hidden="true">
