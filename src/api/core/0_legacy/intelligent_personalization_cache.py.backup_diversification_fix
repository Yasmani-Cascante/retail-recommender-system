...
class IntelligentPersonalizationCache:
    ...
    def _generate_query_hash(self, query: str, context: Dict[str, Any]) -> str:
        ...
        # Usar solo elementos relevantes para evitar cache misses innecesarios
        relevant_context = {
            ...
            # NO incluir timestamps o datos muy específicos
        }
    ...
    def _normalize_query_for_cache(self, query: str) -> str:
        ...
        # ✅ CACHE OPTIMIZATION: Agrupar queries similares de recomendaciones
        if any(word in query_lower for word in ['recommend', 'show', 'suggest', 'find']):
            # Para queries de recomendaciones, usar el mismo hash independientemente de si piden "more"
            return "general_recommendations"  # Unificar todas las queries de recomendaciones
