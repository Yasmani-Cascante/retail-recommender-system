...
class MCPConversationStateManager:
    ...
    async def _save_conversation_state_internal(self, session_id: str, context) -> bool:
        ...
        try:
            ...
            # ✅ REDIS DIRECTO: Sin wrappers, llamadas directas
            if self.redis and await self.redis.ensure_connected():
                logger.info(f"   Redis connection confirmed")
                ...
                logger.error(f"❌ REDIS CONNECTION FAILED during save for {session_id}")
            # ✅ FALLBACK MEMORIA: Siempre guardar en memoria
            ...
            # Garantizar que al menos quede en memoria
