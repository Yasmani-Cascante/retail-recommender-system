    ...
    try:
        ...
        if state_manager:
            try:
                ...
                turn_number = len(conversation_session.turns) + 1 if conversation_session and hasattr(conversation_session, 'turns') else 1  # Usar valor real del session + 1 para el nuevo turn
