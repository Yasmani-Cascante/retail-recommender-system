...
$SERVICE_NAME = "retail-recommender-precomputed"
$REGION = "us-central1"
...
Write-Host "Desplegando versión con embeddings pre-computados" -ForegroundColor Cyan
Write-Host "===================================================" -ForegroundColor Cyan
...
docker build -t $IMAGE_NAME -f Dockerfile.precomputed .
